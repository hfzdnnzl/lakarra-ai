"""Video metrics validation and merge helpers."""

from __future__ import annotations

from typing import Any

# Required before account-level content analytics can run.
...
def metrics_complete(metrics: dict[str, float | int | None]) -> bool:
...
def apply_metrics_to_performance(
    ...
    """Overlay user-provided metrics onto performance data for analysis."""
